...
namespace libmsclb2.Cryptography.Transport
{
    ...
    {
        //public const ulong DefaultAESKey = 0x130806B41B0F3352;
        ...
        public FastAES(byte[] Key)
        {
            WorkingKey = GenerateWorkingKey(ref Key);
        }
        #endregion
        ...
        public unsafe void TransformBlock(ref byte[] block)
        {
        ...
        [SecuritySafeCritical]
        private uint[][] GenerateWorkingKey(ref byte[] key)
        {
            ...
            {
                KeyResult[t >> 2][t & 3] = LeTouint(ref key, i);
                i += 4;
            }
        ...
        private static uint LeTouint(ref byte[] buffer, int off)
        {
